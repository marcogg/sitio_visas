...
<html lang="en">
	...
	<body id="page-top">
		...
		<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
			...
			<div class="container">
				<div class="col-lg-4">
					<p style="color: #7d0000 !important;" class="text-center"><strong><i class="fab fa-whatsapp" style="color: #7d0000;"></i> <a href="https://wa.me/52867 7131020">867 713 1020</a> / <a href="https://wa.me/52867 713 1022">867 713 1022</a>
					</strong></p>
				</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6 mx-auto d-inline text-center" id="contact">
							...
							<p style="color: #00387e;">Lic. J. Félix Mireles Reyes<br>Asesoría Profesional<br>Móvil (Whatsapp): (867) 143 64 10 <br> (867) 231 53 09<br>Tel: 867 714 21 02<br><br>Horarios:<br>Lunes a Viernes de 8:00-18:00hrs.<br>Sábados:<br>9:00-15:00hrs.</p>
						</div>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="d-inline-block text-center col-lg-12">
							...
							<small><p class="text-white">Consulta nuestro <a href="" class="text-white">Aviso de Privacidad</p></a></small>
						</div>
